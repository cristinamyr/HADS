...
urlpatterns = [
    ...
    url(r'^chart/(?P<pregunta_id>\d+)/$', app.views.grafico, name='grafico'),
    url(r'^admin/', include(admin.site.urls)),
    url(r'^quiz/add/', app.views.pregunta_nueva, name='pregunta_nueva'),
    url(r'^quiz/respuesta_add/(?P<pregunta_id>\d+)/$', app.views.anadir_opc, name='anadir_opc'),
    url(r'^(?P<pregunta_id>\d+)/(?P<answer_id>\d+)/resultados/$', app.views.resultados, name='resultados'),
    url(r'^quiz/(?P<pregunta_id>\d+)/$', app.views.detalles, name='detalles'),
    url(r'^quiz/(?P<pregunta_id>\d+)/vote/$', app.views.votar, name='votar'),
    url(r'^quiz/', app.views.index_pregunta, name='index_pregunta'),
