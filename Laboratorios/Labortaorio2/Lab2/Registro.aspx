...
<body>
    <form id="form1" runat="server">
        <div style="height: 910px">
            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="30pt" style="top: 81px; left: 399px; position: absolute; height: 27px; width: 861px" Text="FORMULARIO DE REGISTRO"></asp:Label>
            ...
            <asp:Button ID="l_registrar" runat="server" style="top: 541px; left: 690px; position: absolute; height: 35px; width: 154px" Text="Registrarse" />
            ...
            <asp:RequiredFieldValidator ID="req_name" runat="server" ControlToValidate="l_nombre" ErrorMessage="*" style="top: 198px; left: 852px; position: absolute; height: 27px; width: 20px"></asp:RequiredFieldValidator>
            <asp:RequiredFieldValidator ID="req_apel" runat="server" ControlToValidate="l_apel" ErrorMessage="*" style="top: 241px; left: 853px; position: absolute; height: 27px; width: 20px"></asp:RequiredFieldValidator>
            <asp:RequiredFieldValidator ID="req_email" runat="server" ControlToValidate="l_email" ErrorMessage="*" style="top: 291px; left: 853px; position: absolute; height: 27px; width: 27px"></asp:RequiredFieldValidator>
            <asp:RequiredFieldValidator ID="req_pass" runat="server" ControlToValidate="l_pass" ErrorMessage="*" style="top: 342px; left: 855px; position: absolute; height: 24px; width: 27px"></asp:RequiredFieldValidator>
            <asp:RequiredFieldValidator ID="req_vpass" runat="server" ControlToValidate="l_vpass" ErrorMessage="*" style="top: 392px; left: 856px; position: absolute; height: 27px; width: 31px"></asp:RequiredFieldValidator>
            <asp:RequiredFieldValidator ID="req_rol" runat="server" ControlToValidate="l_rol" ErrorMessage="*" style="top: 455px; left: 771px; position: absolute; height: 27px; width: 26px"></asp:RequiredFieldValidator>
            ...
            <asp:CompareValidator ID="comp_pass" runat="server" ControlToCompare="l_pass" ControlToValidate="l_vpass" ErrorMessage="Las contraseñas no coincden" style="top: 392px; left: 893px; position: absolute; height: 27px; width: 177px"></asp:CompareValidator>
        </div>
    </form>
</body>
</html>
