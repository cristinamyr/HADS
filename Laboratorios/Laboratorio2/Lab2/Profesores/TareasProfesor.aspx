                ...
                <div class="auto-style4">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <br />
                            <br />
                            <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" CssClass="auto-style7" DataKeyNames="Codigo" DataSourceID="GridView_datos" ForeColor="#333333" GridLines="None">
                            ...
                            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" CssClass="auto-style8" DataSourceID="ddl_datos" DataTextField="codigoasig" DataValueField="codigoasig">
                            </asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
